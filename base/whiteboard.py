...
class Whiteboard:
    ...
    def __repr__(self):
        return ("WhriteBoard: ["+"\n amount video to play: " + self.__amount_video_to_play.__repr__() + 
        "\n max buffer size: " + self.__max_buffer_size.__repr__() + 
        "\n Buffer Size: " + str(len(self.__buffer)) + 
        "\n Buffer: " + self.__buffer.__repr__() +
        "\n playback: " + self.__playback.__repr__() +
        "\n playback qi: " + self.__playback_qi.__repr__() +
        "\n playback pauses: " + self.__playback_pauses.__repr__() +
        "\n playback buffer size: " + self.__playback_buffer_size.__repr__() +
        "\n playback segment size time at buffer: " + self.__playback_segment_size_time_at_buffer.__repr__() +
        "\n playback partial sstb: " + self.__partial_sstb.__repr__() +
        " \n]")
